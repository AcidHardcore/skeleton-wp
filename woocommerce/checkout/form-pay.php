	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'skeletonwp' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'skeletonwp' ); ?></th>
			</tr>
		</thead>
		<tbody>
