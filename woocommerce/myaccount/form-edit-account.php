...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post">
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		<label for="account_first_name"><?php esc_html_e( 'First name', 'skeletonwp' ); ?> <span class="required">*</span></label>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
		<label for="account_last_name"><?php esc_html_e( 'Last name', 'skeletonwp' ); ?> <span class="required">*</span></label>
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
		<label for="account_email"><?php esc_html_e( 'Email address', 'skeletonwp' ); ?> <span class="required">*</span></label>
	...
	<fieldset>
		<legend><?php esc_html_e( 'Password change', 'skeletonwp' ); ?></legend>

		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			<label for="password_current"><?php esc_html_e( 'Current password (leave blank to leave unchanged)', 'skeletonwp' ); ?></label>
		...
		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			<label for="password_1"><?php esc_html_e( 'New password (leave blank to leave unchanged)', 'skeletonwp' ); ?></label>
		...
		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			<label for="password_2"><?php esc_html_e( 'Confirm new password', 'skeletonwp' ); ?></label>
	...
	<p>
		...
		<button type="submit" class="btn btn-outline-primary" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'skeletonwp' ); ?>"><?php esc_html_e( 'Save changes', 'skeletonwp' ); ?></button>
