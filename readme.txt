...
Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/skeletonwp.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/skeletonwp)

## About

I’m a huge fan of Underscores, Bootstrap, and Sass. Why not combine these into a solid WordPress Theme Framework?
That’s what skeletonwp is.
You can use it as starter theme and build your own theme on top of it. Or you use it as parent theme and create your own child theme for skeletonwp.

At the moment, skeletonwp is in a very early stage. But if you want, feel free to use it for your own WordPress theme!

# skeletonwp WordPress Theme Framework

Website: [http://skeletonwp.com](http://skeletonwp.com)

Child Theme Project: [https://github.com/holger1411/skeletonwp-child](https://github.com/holger1411/skeletonwp-child)

## License
skeletonwp is released under the terms of the GPL version 2 or (at your option) any later version.
...
Some basics about the Sass and CSS files that come with skeletonwp:
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 1 "theme/theme_variables";  // <--------- Add your variables into this file. Also add variables to overwrite Bootstrap or skeletonwp variables here
                  - 2 "../src/bootstrap-sass/assets/stylesheets/bootstrap";  // <--------- All the Bootstrap stuff - Don´t edit this!
                  - 3 "skeletonwp/skeletonwp"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the skeletonwp folder from GitHub or from skeletonwp.com
- IMPORTANT: If you download it from GitHub make sure you rename the "skeletonwp-master.zip" file just to "skeletonwp.zip" or you might have problems using child themes !!
- Upload it into your WordPress installation subfolder here: `/wp-content/themes/`
- Login to your WordPress backend
- Go to Appearance → Themes
- Activate the skeletonwp theme

## Developing With npm, Gulp and SASS and [Browser Sync][1]

### Installing Dependencies
- Make sure you have installed Node.js and Browser-Sync* (* optional, if you wanna use it) on your computer globally
- Then open your terminal and browse to the location of your skeletonwp copy
